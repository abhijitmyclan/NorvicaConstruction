package com.example.android.norvicaconstruction.adapter;
...
public class CustomImageAdapter extends ArrayAdapter<MyImage> {
    ...
    public CustomImageAdapter(Context context, ArrayList<MyImage> images) {
